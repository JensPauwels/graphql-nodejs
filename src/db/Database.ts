...
class Database {
	...
	getConnection = async (): Promise<mysql2.PoolConnection> => new Promise((resolve, reject) => {
	...
	executeQuery = async (query: string, values: any[]): Promise<any> => new Promise(async (resolve, reject) => {
